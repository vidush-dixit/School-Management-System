...
<div class="bg-white shadow rounded w-full max-w-md mx-auto sm:mt-3" style="z-index: 2;">
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="w-full max-w-lg px-8 mt-6 pb-8 mb-4">
        <?php echo csrf_field(); ?>
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full">
                ...
                <input type="text" name="name" id="name" class="shadow appearance-none border <?php if ($errors->has('name')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('name'); ?> border-red-500 <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?> rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" placeholder="Full Name">
...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            <div class="w-full md:w-1/2 pl-2">
                ...
                <input type="password" name="password_confirmation" id="password-confirm" class="shadow appearance-none border <?php if ($errors->has('password_confirmation')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('password_confirmation'); ?> border-red-500 <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?> rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" placeholder="******************">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vdcoo\Downloads\Laravel Project\Project 1\resources\views/auth/register.blade.php ENDPATH**/ ?>